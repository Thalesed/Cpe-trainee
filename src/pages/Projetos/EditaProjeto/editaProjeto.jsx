...
export function EditaProjeto({ id, edita, setEdita }) {
  ...
  const { mutate: atualizaProjeto } = useUpdateProjetos({
    onSuccess: () => {
  ...
  const onSubmit = (data) => {
    //console.log(id, data);
    atualizaProjeto({ id, body: data });
  };

  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <EditaPopup aberto={edita}>
        ...
        <PopupItem>
          <MensagemPrincipal>Editar Informações</MensagemPrincipal>
        </PopupItem>
